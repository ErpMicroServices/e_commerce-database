...
defineSupportCode(function({
    ...
    Given('I have provided a function type called {function_type:stringInDoubleQuotes}', function(function_type, callback) {
        this.function_type = function_type;
        callback();
    });

    Given('a function type exists called {function_type:stringInDoubleQuotes}', function(function_type) {
    ...
    When('I update the function to {function_type:stringInDoubleQuotes},', function(function_type) {
    ...
    Then('the function list contains {function_type:stringInDoubleQuotes}', function(function_type, callback) {
        expect(this.result.error).to.not.be.ok;
        expect(this.result.data).to.be.ok;
    ...
    Then('the function value in the database is {function_type_value:stringInDoubleQuotes}', function(function_type_value) {
    ...
    Then('the function type called {function_type:stringInDoubleQuotes} does not exist', function(function_type) {
