...
defineSupportCode(function({
    ...
    Given('A website called {arg1:stringInDoubleQuotes}', function(website_url, callback) {
    ...
    Given('a user with username as {stringInDoubleQuotes}', function(user_id, callback) {
        this.user.user_id = user_id;
        callback();
    });

    Given('A user with a password as {stringInDoubleQuotes}', function(password, callback) {
        this.user.password = password;
        callback();
    });

    Given('The user has a preference setting {stringInDoubleQuotes} and {stringInDoubleQuotes}', function(type, value, callback) {
        let type_id = null;
    ...
    Given('a login account history from {stringInDoubleQuotes} thru {stringInDoubleQuotes} a user id of {stringInDoubleQuotes} a password of {stringInDoubleQuotes}', function(active_from, active_thru, user_id, password, callback) {
    ...
    Then('I see user id {stringInDoubleQuotes}', function(user_id, callback) {
