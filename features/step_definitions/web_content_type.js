...
Given('I have provided a web content type called {string}', function (web_content_type, callback) {
	this.web_content_type=web_content_type
	callback()
})

Given('a web content type exists called {string}', function (web_content_type) {
...
When('I update the web content type to {string},', function (web_content_type) {
...
Then('the web content type list contains {string}', function (web_content_type, callback) {
	expect(this.result.error).to.not.be.ok
	expect(this.result.data).to.be.ok
...
Then('the web content type value in the database is {string}', function (web_content_type_value) {
...
Then('the web content type called {string} does not exist', function (web_content_type) {
