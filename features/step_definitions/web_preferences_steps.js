...
defineSupportCode(function({
    ...
    Given('I have provided a web preference type called {web_preference_type:stringInDoubleQuotes}', function(web_preference_type, callback) {
        this.web_preference_type = web_preference_type;
        callback();
    });

    Given('a web preference type exists called {web_preference_type:stringInDoubleQuotes}', function(web_preference_type) {
    ...
    When('I update the web preference to {web_preference:stringInDoubleQuotes},', function(web_preference) {
    ...
    Then('the web preference list contains {web_preference_type:stringInDoubleQuotes}', function(web_preference_type, callback) {
        expect(this.result.error).to.not.be.ok;
        expect(this.result.data).to.be.ok;
    ...
    Then('the web preference value in the database is {web_preference_value:stringInDoubleQuotes}', function(web_preference_value) {
    ...
    Then('the web preference type called {web_preference_type:stringInDoubleQuotes} does not exist', function(web_preference_type) {
